...
'ORIGINAL LINE: this.button2.Click += new System.EventHandler(this.CreateReportDataSourceWithAuthenticationInCodeButton_Click);
			' 
			' label2
			' 
			...
			Me.label2.Text = "Example 1:" & ControlChars.CrLf & "Create the JsonDataSource object based on the connection string that " & "includes authentication parameters."
			' 
			' label1
			' 
			...
			Me.label1.Text = "Example 2:" & ControlChars.CrLf & "Use the JsonDataSource's JsonSource to specify authentication paramet" & "ers in code."
			' 
			' button1
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.button1.Click += new System.EventHandler(this.CreateReportDataSourceWithAuthenticationInCodeButton_Click);
			' 
			' Form1
			' 
